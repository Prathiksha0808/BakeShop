                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                           <?php $id = isset($res['orders_detail_id']) ? (int)$res['orders_detail_id'] : 0; ?>
<tr>
    <td><?php echo $i++; ?></td>
    <td><?php echo htmlspecialchars($res['orders_id']); ?></td>
    <td><?php echo htmlspecialchars($res['product_name']); ?></td>
    <td><?php echo htmlspecialchars($res['quantity']); ?></td>
    <td>
        <button data-toggle="modal" data-target="#exampleModal1" class="btn btn-space btn-primary" onclick="edit_orders_detail(<?= $id ?>)">Edit</button>
        <button onclick="delete_orders_detail(<?= $id ?>)" class="btn btn-space btn-secondary">DELETE</button>
    </td>
</tr>
